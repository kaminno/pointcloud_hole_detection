...
//     markerArray3.markers[idx2].color.a = 1.0f;
    ...
    // std::cout << "get boundary points" << std::endl;
    // std::vector<char> boundaries = get_boundary_points(cloud, K, epsilon, K_2, epsilon_2, k_angle, k_halfdisc, k_shape, trashold);
    // std::cout << "get boundary points done" << std::endl;
...
//                 // (*cloud)[i].r = 255 / (1 + weight);
//                 // (*cloud)[i].g = 255 / (1 + weight);
//                 // (*cloud)[i].b = 0;
...
//         Edge edge = graph[i];
//         // if(components_edges[i].size() > 0){
//         //     std::cout << "components_edges[i].size() " << components_edges[i].size() << std::endl;
//         // }
//         int idx_from = get_component_idx(components_points, edge.from);
//         // std::cout << "after idx from" << std::endl;
//         int idx_to = get_component_idx(components_points, edge.to);
...
//             // auto idx_from = i;
//             // Edge edge = components_edges[i][j];
...
//     //     }
//     // }
//     for(int i = 0; i < components_max_cycle_edge.size(); i++){
//         if(components_max_cycle_edge[i].from < 0){
//             continue;
//         }
//     visualization_msgs::Marker marker;
//                 marker.header.frame_id = "base_frame";
//                 marker.header.stamp = ros::Time::now();
//                 marker.action = visualization_msgs::Marker::ADD;
//                 marker.id = components_max_cycle_edge[i].from*100990 + components_max_cycle_edge[i].to*5;
//                 marker.type = visualization_msgs::Marker::ARROW;
//                 marker.scale.x = 0.003;
//                 marker.scale.y = 0.005;
//     //             marker.scale.z = 0.2;
...
//     //             marker.pose.position.z = (*cloud)[i].z;
//                 geometry_msgs::Point p0;
//                 p0.x = (*cloud)[components_max_cycle_edge[i].from].x;
//                 p0.y = (*cloud)[components_max_cycle_edge[i].from].y;
//                 p0.z = (*cloud)[components_max_cycle_edge[i].from].z;
//                 geometry_msgs::Point p1;
//                 p1.x = (*cloud)[components_max_cycle_edge[i].to].x;
//                 p1.y = (*cloud)[components_max_cycle_edge[i].to].y;
//                 p1.z = (*cloud)[components_max_cycle_edge[i].to].z;
//                 marker.points.push_back(p0);
//                 marker.points.push_back(p1);
//                 markerArray.markers.push_back(marker);
//     }
...
//                             // marker3.id = e.from*1090 + e.to*8;
//                             // marker3.type = visualization_msgs::Marker::POINTS;
//                             // marker3.scale.x = 0.003;
